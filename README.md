...
A high-precision Pi calculator that computes Pi to 12 decimal places using Machin's formula for fast convergence and accuracy.
...
- Guaranteed accuracy to 12 decimal places
...
The implementation uses Machin's formula, discovered in 1706, which converges rapidly and is ideal for high-precision calculations. The arctangent function is computed using Taylor series expansion with sufficient terms to ensure accuracy.

For detailed documentation, see [Pi Calculator Documentation](docs/pi_calculator.md)
