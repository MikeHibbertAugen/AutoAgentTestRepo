...
A high-precision Pi calculator that computes Pi to 9 decimal places using Machin's formula.
...
**Features:**
- Calculates Pi to exactly 9 decimal places (3.141592654)
- Uses Machin's formula for high accuracy and efficiency
- No external dependencies (uses Python standard library only)
- Deterministic and consistent results
- Type-safe with full type hints
- Comprehensive test coverage
- Pure mathematical computation with no side effects

**Algorithm:**
- Uses Machin's formula: π/4 = 4·arctan(1/5) - arctan(1/239)
- Leverages Python's `decimal` module for arbitrary precision arithmetic
- Taylor series expansion for arctangent calculations
- Guaranteed accuracy to 9 decimal places
